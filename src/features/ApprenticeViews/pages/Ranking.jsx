  ...
  const categoryData = {
    ...
    programa: {
      podium: [
        ...
        { position: 1, name: "Rafael P.", points: 967 },
        { position: 3, name: "María López", points: 780 },
      ],
      currentUser: {
        position: 1,
        name: "Rafael P.",
            ...
            <div className="grid grid-cols-3 gap-4 w-full max-w-2xl">
              ...
              <div className="flex flex-col items-center">
                <div className="relative mb-2">
                  ...
                  <div className="w-20 h-20 rounded-full bg-gradient-to-b from-gray-300 to-gray-400 flex items-center justify-center shadow-lg">
                    {getPodiumIcon(activeTab, 2)}
                  </div>
                </div>
                <div className="text-center">
                  <p className="font-semibold text-gray-800 text-sm">{currentData.podium[0].name}</p>
                  <p className="text-gray-600 text-xs">{currentData.podium[0].points} pts</p>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center">
                <div className="relative mb-2">
                  ...
                  <div className="w-24 h-24 rounded-full bg-gradient-to-b from-yellow-400 to-yellow-500 flex items-center justify-center shadow-xl">
                    {getPodiumIcon(activeTab, 1)}
                  </div>
                </div>
                <div className="text-center">
                  <p className="font-bold text-yellow-800 text-base">{currentData.podium[1].name}</p>
                  <p className="text-yellow-700 text-sm font-medium">{currentData.podium[1].points} pts</p>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center">
                <div className="relative mb-2">
                  <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                    <div className="bg-amber-200 rounded-full w-6 h-6 flex items-center justify-center shadow-md">
                      <span className="text-amber-800 text-xs font-bold">3</span>
                    </div>
                  </div>
                  <div className="w-20 h-20 rounded-full bg-gradient-to-b from-amber-600 to-amber-700 flex items-center justify-center shadow-lg">
                    {getPodiumIcon(activeTab, 3)}
                  </div>
                </div>
                <div className="text-center">
                  <p className="font-semibold text-amber-800 text-sm">{currentData.podium[2].name}</p>
                  <p className="text-amber-700 text-xs">{currentData.podium[2].points} pts</p>
                </div>
              </div>
            </div>
          </div>
